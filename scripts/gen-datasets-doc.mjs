...
p('Before the first CSV, Excel or TXT export of a session, a form collects **name, email, organisation and'
  + ' intended use**. Details are remembered for the session and prefilled on later visits.');
